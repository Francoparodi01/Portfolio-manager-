...
AVAILABLE_TOOLS = {
    ...
    "get_decision_ledger", "get_system_status", "get_meta_policy", "compare_plan_vs_hold",
    "get_decision_value_added", "get_decision_counterfactuals", "get_similar_historical_episodes",
